...
| **Observability / Infrastructure Health**         | GCP Cloud Logging / Sentry                 | None in Firestore                                                             | GCP IAM                             | **DEFERRED** _(Zero fake dials rendered)_ |
...
| --- | --------------------------------- | ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Overview Triage**               | Generic statistics dominated without answering _"Does anything need my attention right now?"_. | Action-first summary cards: Pending safety reports highlighted with active status badge (`"Review needed"` vs `"Queue clear ✓"`), 1-click navigation to queue.              |
