...
## UI / UX patterns
- **Visual language:** Apple-style restraint — neutral palette, one accent, generous whitespace, large readable type, purposeful motion only. WCAG 2.1 AA throughout.
