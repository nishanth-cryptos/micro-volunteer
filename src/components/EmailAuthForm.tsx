    ...
    >
      ...
      {showForgotNote && (
        <div className="rounded-xl border border-[#ececea] bg-[#f3f1ec] p-3 text-xs leading-relaxed text-[#4f4b46]">
          <strong className="text-[#131312]">Account Recovery:</strong>{' '}
          Automated email password reset is queued for the upcoming Phase 2
          release. If you are locked out, you can sign in directly using your
          registered <strong className="text-[#1f6f5c]">Phone OTP</strong>.
        </div>
      )}
